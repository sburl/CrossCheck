...
## Delegation Pattern (shared with /claude-delegate)
...
Unlike Claude, Gemini does NOT auto-apply changes. YOU must:
...
- Unlike Claude, Gemini doesn't auto-apply changes - YOU must apply them
