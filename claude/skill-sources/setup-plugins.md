...
# Setup Plugins for Claude Workflow
...
| `/pr-review` | `code-review` | **Complementary** — skill delegates to Claude, plugin adds multi-agent scoring | Install both |
| `/pr-review` | `pr-review-toolkit` | **Complementary** — skill delegates to Claude, plugin adds dimensional reviewers | Install both |
...
- `code-review` plugin adds scoring to inline reviews; `/pr-review` skill orchestrates the full Claude review handoff
