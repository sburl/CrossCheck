...
When `/pre-pr-check` is invoked, Claude runs these checks:
...
Modified docs:
CLAUDE.md
⚠️  CLAUDE.md: timestamp not updated to today
...
## Manual Checks (Claude performs)

In addition to automated checks, Claude should verify:
