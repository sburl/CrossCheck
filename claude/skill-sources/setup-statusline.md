...
description: Customize Claude statusline for better context awareness
---
...
Customize your Claude statusline to show context usage, git branch, and PR counter.

> "For easier Claude-juggling, use /statusline to customize your status bar to always show context usage and current git branch." - Claude team
...
- Multiple worktrees
- Daily Claude use
- Following Claude automation workflow
