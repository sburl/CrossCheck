...
## Claude Review Autonomy

**Core Principle:** Claude works autonomously. Don't interrupt unless non-responsive.
...
**Trust Claude autonomy. Don't impose arbitrary timeouts.**

See @CLAUDE-PROMPTS.md for complete Claude integration details.
