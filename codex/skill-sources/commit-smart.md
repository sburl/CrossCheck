...
- **DO NOT add `Co-Authored-By: Codex` or any AI co-author line** - commits should appear as user-authored
...
4. **Check if docs need updating** - if the change introduces a gotcha, design decision, or behavior change, add a brief note to the relevant `.md` file (e.g., CODEX.md, QUICK-REFERENCE.md). Keep it minimal.
