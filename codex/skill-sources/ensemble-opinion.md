...
1. **Codex Critic** (subagent_type: codex_critic)
...
- **Critic**: [key points from codex_critic]
...
- If Gemini fails (auth): note it, continue with Codex + Critic
...
- Inject CODEX.md context directly into prompt (don't rely on AGENTS.md)
