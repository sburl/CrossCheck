...
Create a new git worktree to work on multiple features in parallel. This is the **#1 productivity tip** from the Claude team.
...
# Copy .claude structure from main worktree
cp -r /path/to/main/.claude .claude/
...
# Copy CLAUDE.md
cp /path/to/main/CLAUDE.md ./
```

### Step 3: Launch Claude Session
...
echo "(CLAUDE.md will be auto-loaded in the worktree)"
```
...
# Feature Auth Claude: Implementing OAuth
# Feature UI Claude: Building new dashboard
# Bugfix Claude: Fixing login race condition
...
✅ **Independent Claude sessions** - Each with own context
...
# Open 3 terminal tabs, start 3 Claude sessions
