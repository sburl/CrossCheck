...
description: Customize Claude Code statusline for better context awareness
---
...
Customize your Claude Code statusline to show context usage, git branch, and PR counter.

> "For easier Claude-juggling, use /statusline to customize your status bar to always show context usage and current git branch." - Claude Code team
...
- Multiple worktrees (3-5 Claude sessions)
...
When running 3-5 Claude sessions, you need to quickly identify which is which:
...
- Multiple worktrees
- Daily Claude use
- Following Claude Code automation workflow
...
# For real-time: check Claude's response
...
CONTEXT=$(claude context-usage)  # Hypothetical
...
- `CLAUDE.md` - Workflow auto-loaded (includes statusline recommendations)
