...
# Setup Automation for Claude Workflow
...
4. **After setup, tell the user:**
   ...
   IMPORTANT: You need to restart Claude for skills to work in future sessions:
...
**IMPORTANT:** Skills are loaded at startup. The user MUST restart Claude after running setup for the first time.
...
- **post-commit**: Checkpointing, assessment counter, Claude review
...
git commit -m "chore: initialize Claude automation structure"
git push
```
